...
4. **Thread the bench (or throw a hit)**: Static computer players line the benches and crease. You can’t skate or shoot through them, but colliding at speed now body-checks them—NPCs slide across the ice for a beat before settling, just like an authentic NHL '93 hit.
